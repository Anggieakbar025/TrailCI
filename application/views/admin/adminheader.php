            ...
            <div class="menu-sidebar2__content js-scrollbar1">
                <div class="account2">
                    <div class="image img-cir img-120">
                        <img src="<?= base_url() ?>assets/img/hehe.jpg" alt="John Doe" />
                    </div>
                    <h4 class="name">Anggie Akbar</h4>
                    <a href="<?= base_url('login/logout') ?>">Sign out</a>
                </div>
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        <li class="active has-sub">
                            <a class="js-arrow" href="<?= base_url('home/admin') ?>">
                                <i class="fas fa-tachometer-alt"></i>Dashboard
                                <!-- <span class="inbox-num">3</span> -->
                            </a>
                        </li>
                        <li class="active has-sub">
                            <a class="js-arrow" href="<?= base_url('home/user') ?>">
                              <i class="fas fa-users"></i>User Data
                                
                            </a>
                        </li>
                        <li class="active has-sub">
                            <a class="js-arrow" href="<?= base_url('home/orderList') ?>">
                              <i class="fas fa-list-ul"></i>List Order
                                
                            </a>
                        </li>
                        <li class="active has-sub">
                            <a class="js-arrow" href="<?= base_url('home/jual') ?>">
                            <i class="far fa-calendar-check"></i>Data Penjualan
        ...
        <div class="page-container2">
            ...
            <aside class="menu-sidebar2 js-right-sidebar d-block d-lg-none">
                ...
                <div class="menu-sidebar2__content js-scrollbar2">
                    <div class="account2">
                        <div class="image img-cir img-120">
                            <img src="<?= base_url() ?>assets/img/hehe.jpg"  />
                        </div>
                        <h4 class="name"> Anggie Akbar</h4>
                        <a href="<?= base_url('login/logout') ?>">Sign out</a>
                    </div>
